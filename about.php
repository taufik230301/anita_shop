        ...
        <div class="container">
            ...
            <div class="about-agileinfo w3layouts">
                <div class="col-md-20 about-wthree-grids grid-top">
					...
					<br>
					Fitur E-Commerce pada web ini dikembangkan oleh Anita Pridayani</p> -->
        ...
        <div class="footer-botm">
            <div class="container">
                <div class="w3layouts-foot">
                    <ul>
                        <li><a href="satuaja.thrift" class="w3_agile_facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                        <li><a href="#" class="agile_twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                        <li><a href="instagram.com/satuaja.thrift" class="w3_agile_instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
