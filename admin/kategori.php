...
<head>
    ...
    <title>Kelola Kategori - Hexagon Thrifting</title>
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
                                                    ...
                                                    <td><a data-toggle="modal" data-target="#myModal<?php echo $p['idkategori']; ?>" type="button" title="edit data"><button class="btn"><i class="fa fa-edit"></i></button></a></td>
													<td><a href="hapuskategori.php?idkategori=<?php echo $p['idkategori'];?>" title="edit data"><button class="btn"><i class="fa fa-trash"></i></button></a></td>
													
												</tr>
                                                <!-- modal update -->
<div id="myModal<?php echo $p['idkategori'];?>" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form action="editkategori.php" method="get" enctype="multipart/form-data" >
								<?php
								$id = $p['idkategori'];
								$query_edit = mysqli_query($conn,"SELECT * from kategori where idkategori='$id'");
								while($p=mysqli_fetch_array($query_edit)) {
									?>
									<input type="hidden" name="idkategori" type="text" class="form-control" value="<?php echo $p['idkategori'];?>"required autofocus>
