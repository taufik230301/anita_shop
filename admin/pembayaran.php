...
<head>
    ...
    <title>Kelola Metode Pembayaran - Hexagon Thrifting</title>
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td><?php echo $p['an'] ?></td>
                                                	<td><a data-toggle="modal" data-target="#myModal<?php echo $p['no']; ?>" type="button" title="edit data"><button class="btn"><i class="fa fa-edit"></i></button></a></td>
													<td><a href="hapuspembayaran.php?no=<?php echo $p['no'];?>" title="edit data"><button class="btn"><i class="fa fa-trash"></i></button></a></td>
													
												</tr>	

                                                <!-- modal update -->
<div id="myModal<?php echo $p['no'];?>" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form action="editpembayaran.php" method="get" enctype="multipart/form-data" >
								<?php
								$id = $p['no'];
								$query_edit = mysqli_query($conn,"SELECT * from pembayaran where no='$id'");
								while($p=mysqli_fetch_array($query_edit)) {
									?>
									<input type="hidden" name="no" type="text" class="form-control" value="<?php echo $p['no'];?>"required autofocus>
								...
								<div class="form-group">
									...
									<input name="norek" type="text" class="form-control" value="<?php echo $p['norek'] ?>" required autofocus>
								</div>
								<div class="form-group">
									<label>Atas Nama</label>
									<input name="an" type="text" class="form-control" value="<?php echo $p['an'];?>"required autofocus>
								</div>
							
								<div class="form-group">
									<label>URL logo</label>
									<input name="logo" type="text" class="form-control" value="<?php echo $p['an'] ?>" required autofocus>
								</div>
								<!-- <div class="form-group">
									<label>Gambar</label>
									<input name="uploadgambar" type="file" class="form-control" value="<?php echo $p['uploadgambar'] ?>">
								</div> -->

							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
								<input name="addproduct" type="submit" class="btn btn-primary" value="Edit">
							</div>
							<?php
							}
							?>
