...
<head>
    ...
    <title>Hexagon Thrifting - Konfirmasi Pembayaran</title>
    <!-- for-mobile-apps -->
                ...
                <div class="col-md-4 w3_footer_grid">
                    ...
                    <ul class="address">
                        ...
                        <li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a
                                href="satuaja.thrift@email">info@email</a></li>
    ...
    <div class="footer-botm">
        <div class="container">
            <div class="w3layouts-foot">
                <ul>
                    <li><a href="http://instagram.com/satuaja.thrift/"><i class="fa fa-instagram"
                                aria-hidden="true"></i></a></li>
                    <li><a href="http://facebook.com/satuaja.thrift/"><i class="fa fa-facebook"
                                aria-hidden="true"></i></a></li>
