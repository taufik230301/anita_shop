...
if(isset($_POST['confirm']))
	{
		...
		$path = "konfirmasi/".$random.'.'.$ext;
		$pathdb = "konfirmasi/".$random.'.'.$ext;

		if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
		  if($ukuran_file <= 5000000){ 
			if(move_uploaded_file($tmp_file, $path)){ 

		$kon = mysqli_query($conn,"insert into konfirmasi (orderid, userid, payment, namarekening, tglbayar, gambar, alamat) 
		values('$idorder','$userid','$metode','$nama','$tanggal','$pathdb','$alamat')");
		if ($kon){
		...
		<meta http-equiv='refresh' content='7; url= index.php'/>  ";
		 ...
		 <meta http-equiv='refresh' content='3; url= konfirmasi.php'/> ";
												...
												Terjadi Kesalahan Dalam Mengupload File
												</div>
...
<title>Satuaja Thrift - Konfirmasi Pembayaran</title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<h6>Informasi Pembayaran</h6>
					...
					<input type="file" class="form-control" name="uploadgambar">
	...
	<div class="footer-botm">
			<div class="container">
				<div class="w3layouts-foot">
					<ul>
						<li><a href="http://instagram.com/satuaja.thrift/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
						<li><a href="http://facebook.com/satuaja.thrift/"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						<li><a href="http://wa.me/089616120301/"><i class="fa fa-whatsapp" aria-hidden="true"></i></a></li>
					</ul>
				</div>
